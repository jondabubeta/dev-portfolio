...
export const welcomeText = (
  <div className="welcome-container">
    ...
    <p className="section-title">
      <span className="text-blue">How the Terminal Works</span>
    </p>
    ...
    <p className="section-title">
      <span className="text-pink">Sidebar Icons Guide</span>
    </p>
    ...
    <p>
      Click on any sidebar item or icon to navigate, or type <span className="text-blue">help</span> to get started!
    </p>
  </div>
);
